...
class ClassroomTeacherTController extends Controller
{
    /**
    ...
    {
        $users = User::where('role', 'classroom_teacher')->paginate(10);
        return view('dashboard.admin.Classroom-Teacher Table.classroomTeacherT', compact('users'));
    }
