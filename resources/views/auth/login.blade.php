...
<body>
    ...
    <div class="w-full h-screen flex px-20 py-10 font-Mplus1 justify-between">
        ...
        <div class="flex flex-col justify-between w-[30%]">
            ...
            <p class="text-xl font-bold order-1 text-header"><span class="text-blue-main-200 text-2xl">V</span>ALERIA.</p>
                ...
                <form action="/dashboard" class="flex flex-col mt-11 gap-2">
                    ...
                    <label for="email" class="flex bg-form-bg w-full py-3 px-3 gap-3 items-center rounded-lg transition-all ease-in-out duration-100 hover:border focus-within:border invalid:border invalid:border-red-600 group/form mb-5">
                        ...
                        <label for="email" class="p-2 bg-white flex items-center rounded-lg">
                            <svg width="20" height="19" class="stroke-blue-main-200 invalid:stroke-red-600 group-focus-within/form:stroke-blue-main-100 transition-all duration-100 ease-in-out" viewBox="0 0 22 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <label for="pass" class="flex bg-form-bg w-full py-3 px-3 gap-3 items-center rounded-lg transition-all ease-in-out duration-100 hover:border focus-within:border invalid:border invalid:border-red-600 group/form">
                        ...
                        <label for="pass" class="p-2 bg-white flex items-center rounded-lg">
                            <svg width="18" height="20" class="fill-blue-main-200 invalid:fill-red-600 group-focus-within/form:fill-blue-main-100 transition-all duration-100 ease-in-out" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="flex justify-between items-center mb-5">
                        ...
                        <a href="" class="ml-auto">
                            <span class="font-light text-xs text-blue-main-100">Forgot password ?</span>
                        </a>

                    </div>
                    

                    <button class="bg-gradient-to-tr from-blue-main-200 to-blue-main-100 to-40% py-4 rounded-lg shadow-lg hover:scale-[.98] transition-all duration-300 ease-in-out">
