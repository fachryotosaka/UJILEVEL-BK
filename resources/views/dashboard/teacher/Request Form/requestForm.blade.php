...
@section('dcontent')
    ...
    <div class=" w-full h-full flex flex-col py-10 pt-8 px-12 pr-10 overflow-y-auto hide-scroll relative">
        ...
        <div class="flex items-start h-full gap-8 mt-10 relative">
            ...
            <div id="decline-form" class="w-full bg-white z-10 h-0 absolute font-Mplus1cus flex-col flex transition" style="display: none">
            ...
            <div id="finish-form" class="w-full bg-white z-10 h-0 absolute font-Mplus1cus flex-col flex transition" style="display: none">
