    ...
    <div class="w-full h-full flex flex-col overflow-y-auto hide-scroll py-10 px-12 pt-2">
        ...
        <div class="w-full h-full flex gap-24 font-Mplus1cus">
                        ...
                        <details class="w-full h-fit border bg-white border-[#E2E8F0] cursor-pointer rounded-md p-3 px-4 relative flex flex-col before:absolute before:-z-10 before:h-full before:-right-1 before:-bottom-1 before:rounded-md before:border before:w-full">
                            <summary id="detail" class="flex items-center gap-4">
                                ...
                                <div class="w-8 h-8 bg-cover bg-center rounded" style="background-image: url({{ $firstImageStudent[$consultation->id]->profile_photo_url ?? '' }})"></div>
                                  @if($consultation->service_name === 'Social Counseling')
                                      <p class="font-bold text-xs text-header">
                            ...
                            <ul class="content flex flex-col gap-4 pt-6 cursor-default">
                                ...
                                <li class="flex items-center w-full">
                                    ...
                                    <p class="text-header/80 text-xs font-semibold max-w-[40%] block text-right overflow-ellipsis ml-auto text-limit">{{$consultation->title}}</p>
                                </li>

                                <li class="flex items-center">
                                    <p class="text-[11px] text-subheader/50 font-medium">Description</p>

                                    <p class="text-header/80 text-xs font-semibold max-w-[40%] block text-right overflow-ellipsis ml-auto text-limit">{{$consultation->description}}</p>
                                </li>

                                <li class="flex items-center">
                                    <p class="text-[11px] text-subheader/50 font-medium">Consultation Type</p>

                                    <p class="text-header/80 text-xs font-semibold max-w-[40%] block text-right overflow-ellipsis ml-auto text-limit">{{ $consultation->service_name }}</p>
                                </li>

                                <li class="flex items-center">
                                    <p class="text-[11px] text-subheader/50 font-medium">Place</p>

                                    <p class="text-header/80 text-xs font-semibold max-w-[40%] block text-right overflow-ellipsis ml-auto text-limit">{{ $consultation->place }}</p>
                                </li>

                                <li class="flex items-center">
                                    <p class="text-[11px] text-subheader/50 font-medium">Date</p>

                                    <p class="text-header/80 text-xs font-semibold max-w-[40%] block text-right overflow-ellipsis ml-auto text-limit">{{ \Carbon\Carbon::createFromFormat('Y-m-d', $consultation->date)->format('d F Y') }}</p>
                                </li>

                                <li class="flex items-center">
                                    <p class="text-[11px] text-subheader/50 font-medium">Time</p>

                                    <p class="text-header/80 text-xs font-semibold max-w-[40%] block text-right overflow-ellipsis ml-auto text-limit">{{ \Carbon\Carbon::parse($consultation->time)->format('h:i A') }}</p>
                                </li>
            ...
            <div class="flex flex-col w-[calc(100%/4)] h-fit">
                ...
                <div class="flex items-center w-full gap-3 px-0.5">
                    <p class="font-Mulish font-extrabold text-[13px] text-[#1E293B] tracking-wide uppercase">Approve</p>
                          ...
                          <details class="w-full h-fit border bg-white border-[#E2E8F0] cursor-pointer rounded-md p-3 px-4 relative flex flex-col before:absolute before:-z-10 before:h-full before:-right-1 before:-bottom-1 before:rounded-md before:border before:w-full">
                              ...
                              <ul class="content flex flex-col gap-4 pt-6 cursor-default">
                                  ...
                                  <li class="flex items-center w-full">
                                      ...
                                      <p class="text-header/80 text-xs font-semibold max-w-[40%] text-right block overflow-ellipsis ml-auto text-limit">{{$consultation->title}}</p>
                                  </li>
  
                                  <li class="flex items-center">
                                      <p class="text-[11px] text-subheader/50 font-medium">Description</p>
  
                                      <p class="text-header/80 text-xs font-semibold max-w-[40%] text-right block overflow-ellipsis ml-auto text-limit">{{$consultation->description}}</p>
                                  </li>
  
                                  <li class="flex items-center">
                                      <p class="text-[11px] text-subheader/50 font-medium">Consultation Type</p>
  
                                      <p class="text-header/80 text-xs font-semibold max-w-[40%] text-right block overflow-ellipsis ml-auto text-limit">{{ $consultation->service_name }}</p>
                                  </li>
  
                                  <li class="flex items-center">
                                      <p class="text-[11px] text-subheader/50 font-medium">Place</p>
  
                                      <p class="text-header/80 text-xs font-semibold max-w-[40%] text-right block overflow-ellipsis ml-auto text-limit">{{ $consultation->place }}</p>
                                  </li>
            ...
            <div class="flex flex-col w-[calc(100%/4)] h-fit">
                ...
                <div class="flex items-center w-full gap-3 px-0.5">
                    <p class="font-Mulish font-extrabold text-[13px] text-[#1E293B] tracking-wide uppercase">Revised</p>
