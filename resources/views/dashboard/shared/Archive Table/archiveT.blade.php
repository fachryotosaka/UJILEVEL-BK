                        ...
                        <details class="w-full h-fit border bg-white border-[#E2E8F0] cursor-pointer rounded-md p-3 px-4 relative flex flex-col before:absolute before:-z-10 before:h-full before:-right-1 before:-bottom-1 before:rounded-md before:border before:w-full">
                            <summary id="detail" class="flex items-center gap-4">
                              ...
                              @foreach($groupedConsultations[$consultation->id] as $user)
                                ...
                                <div class="w-8 h-8 bg-cover bg-center rounded" style="background-image: url({{ $user->profile_photo_url }})"></div>
                            ...
                            <ul class="content flex flex-col gap-4 pt-6 cursor-default">
                                ...
                                <li class="flex items-center">
                                    ...
                                    <p class="text-header/80 text-xs font-semibold max-w-[40%] overflow-ellipsis ml-auto text-limit">{{ $consultation->service_name }}</p>
                                </li>
                                ...
                                <a id="btn-detail-request" for="tw-modal" data-id="detailrequest" class="cmodal cursor-pointer font-Mulish text-white py-2.5 font-bold text-xs text-center rounded tracking-wide bg-[#306BFF] hover:scale-[.98] transition duration-300">
                                    View
                                </a>
                          ...
                          <details class="w-full h-fit border bg-white border-[#E2E8F0] cursor-pointer rounded-md p-3 px-4 relative flex flex-col before:absolute before:-z-10 before:h-full before:-right-1 before:-bottom-1 before:rounded-md before:border before:w-full">
                              ...
                              <summary id="detail" class="flex items-center gap-4">
                                ...
                                @if(Auth::user()->role === 'teacher')
                                  ...
                                  <p class="font-bold text-xs text-header">{{$groupedConsultations[$consultation->id] === '' ? $groupedConsultations[$consultation->id] : 'All classes'}}</p>
                                @else
                                  <div class="w-8 h-8 bg-cover bg-center rounded" style="background-image: url({{ Auth()->user()->profile_photo_url }})"></div>
                          ...
                          <details class="w-full h-fit border bg-white border-[#E2E8F0] cursor-pointer rounded-md p-3 px-4 relative flex flex-col before:absolute before:-z-10 before:h-full before:-right-1 before:-bottom-1 before:rounded-md before:border before:w-full">
                              ...
                              <summary id="detail" class="flex items-center gap-4">
                                ...
                                @if(Auth::user()->role === 'teacher')
                                  ...
                                  <p class="font-bold text-xs text-header">{{$groupedConsultations[$consultation->id]}}</p>
                                @else
                                  <div class="w-8 h-8 bg-cover bg-center rounded" style="background-image: url({{ Auth()->user()->profile_photo_url }})"></div>
