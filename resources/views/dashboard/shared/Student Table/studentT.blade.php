...
<div class="pl-12 w-full font-Mplus1cus mt-16">
 ...
 <div class="flex items-center gap-1 mb-2">
                ...
                <a  href="javascript:void(0)" for="tw-modal" id="btn-create-student" data-id="add" class="m-0 cmodal cursor-pointer text-subheader font-bold text-[13px] hover:scale-95 transition duration-200">+ add</a>
                @endif
                <a class="btn btn-success mb-2" style="display: none" id="btn-reset-search">Reset</a>
            </div>

            <table class="w-full" id="table-student">
                <thead>
