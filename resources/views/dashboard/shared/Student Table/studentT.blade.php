...
<div class="pl-12 w-full font-Mplus1cus mt-2">
    ...
    <div class="flex flex-col text-xs leading-none mb-12">
        <div class="flex items-center gap-2 font-medium">
            ...
            <p class="text-subheader">Student Table</p>
        </div>
    </div>

    <div class="flex items-center gap-1 mb-2">
        <p class="text-header font-semibold text-xl">Student Data</p>
            ...
            <table class="w-full" id="table-student">
                ...
                <tbody id="table-student-body">
                    ...
                    <tr class="font-medium text-[13px] text-header text-left"  id="index_{{ $item->id }}">
                        ...
                        @if (Auth::user()->role === 'admin')
                            <td class="p-4 py-[10px] px-0 flex items-center gap-6 w-fit">

                                <button id="btn-delete-student" data-id="{{ $item->id }}" class="">
                                ...
                                <a href="javascript:void(0)" id="btn-edit-student" data-id="{{ $item->id }}" class="cursor-pointer ">
