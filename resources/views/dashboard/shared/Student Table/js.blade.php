<script>
    ...
    $('body').on('click', '#btn-create-student', function () {
    ...
    student_id = $(this).data('id');
                    ...
                    if(response.status == 'Classroom is occupied') {
                        ...
                        Swal.fire({
                            ...
                            <td class="p-3 py-[10px] px-0 flex items-center gap-2 w-fit">
                                ...
                                <button id="btn-delete-student" data-id="{{ $item->id }}" class="w-9 h-9 flex justify-center items-center border border-footer border-opacity-70 rounded-lg hover:scale-95 transition-all ease-in-out duration-200 hover:border-opacity-100">
                                ...
                                <a href="javascript:void(0)" id="btn-edit-student" data-id="{{ $item->id }}" class="cursor-pointer w-9 h-9 flex justify-center items-center border border-footer border-opacity-70 rounded-lg hover:scale-95 transition-all ease-in-out duration-200 hover:border-opacity-100">
                            ...
                            <button id="btn-delete-student" data-id="{{ $item->id }}" class="w-9 h-9 flex justify-center items-center border border-footer border-opacity-70 rounded-lg hover:scale-95 transition-all ease-in-out duration-200 hover:border-opacity-100 group/hover">
        ...
        //button create post event
        $('body').on('click', '#btn-delete-student', function () {
