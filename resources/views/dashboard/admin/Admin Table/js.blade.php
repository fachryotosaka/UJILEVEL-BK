                    ...
                    if(response.status == 'Classroom is occupied') {
                        ...
                        let post = `
                            ...
                            <td class="text-center">
                                <a href="javascript:void(0)" id="btn-edit-admin" data-id="${response.data.id}" class="btn btn-primary btn-sm">EDIT</a>
                                <a href="javascript:void(0)" id="btn-delete-admin" data-id="${response.data.id}" class="btn btn-danger btn-sm">DELETE</a>
                            </td>
                            </tr>
                        `;
