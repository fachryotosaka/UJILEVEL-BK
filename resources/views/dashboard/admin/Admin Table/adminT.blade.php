                    ...
                    <tbody id="table-admin-body">
                      ...
                      <tr id="index_{{ $item->id }}">
                          ...
                          <td class="text-center">
                              <a href="javascript:void(0)" id="btn-edit-admin" data-id="{{ $item->id }}" class="btn btn-primary btn-sm">EDIT</a>
                              <a href="javascript:void(0)" id="btn-delete-admin" data-id="{{ $item->id }}" class="btn btn-danger btn-sm">DELETE</a>
                          </td>
                      </tr>
                      @endforeach
                    </tbody>
