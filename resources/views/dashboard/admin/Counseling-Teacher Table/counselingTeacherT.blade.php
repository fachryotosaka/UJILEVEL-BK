...
<div class="pl-12 w-full font-Mplus1cus mt-2">
    ...
    <div class="flex flex-col text-xs leading-none mb-12">
        <div class="flex items-center gap-2 font-medium">
            ...
            <p class="text-subheader">Counseling Teacher Table</p>
        </div>
    </div>

    <div class="flex items-center gap-1 mb-2">
        <p class="text-header font-semibold text-xl">Counseling Teacher Data</p>
    ...
    <a  href="javascript:void(0)" for="tw-modal" id="btn-create-teacher" data-id="add" class="cmodal cursor-pointer text-subheader font-bold text-[13px] hover:scale-95 transition duration-200">+ add</a>

            <table class="w-full" id="table-teacher">
                <thead>
                ...
                <tbody id="table-teacher-body">
                    ...
                    <tr class="font-medium text-[13px] text-header text-left"  id="index_{{ $item->id }}">
                        ...
                        <td class="p-4 py-[10px] pl-0">{{ $item->role }}</td>
                        <td class="p-4 py-[10px] pl-0">{{ $item->classroom->name ?? 'No Class' }}</td>
                        <td class="p-3 py-[10px] px-0 flex items-center gap-2 w-fit">

                            <button id="btn-delete-teacher" data-id="{{ $item->id }}" class="w-9 h-9 flex justify-center items-center rounded-lg hover:scale-95 transition-all ease-in-out duration-200 hover:border-opacity-100">
                            ...
                            <a href="javascript:void(0)" id="btn-edit-teacher" data-id="{{ $item->id }}" class="cursor-pointer w-9 h-9 flex justify-center items-center rounded-lg hover:scale-95 transition-all ease-in-out duration-200 hover:border-opacity-100">
