<script>
    ...
    $('#modal-classroom-teacher').on('hidden.bs.modal', function() {
    ...
    $('body').on('click', '#btn-create-classroom-teacher', function () {

        var path = "{{ route('findClass') }}";
            $('#classroom').select2({
            dropdownParent: $('#modal-classroom-teacher'),
        ...
        //open modal
        $('#modal-classroom-teacher').modal('show');
    });

    //update function js

     //button edit teacher event
    $('body').on('click', '#btn-edit-classroom-teacher', function () {
    ...
    teacher_id = $(this).data('id');
            ...
            if (isCreateAction) {
                ...
                success:function(response){
                    ...
                    if(response.status == 'Classroom is occupied') {
                        ...
                        Swal.fire({
                           ...
                           let post = `
                            ...
                            <td class="p-3 py-[10px] px-0 flex items-center gap-2 w-fit">
                                ...
                                <button id="btn-delete-classroom-teacher" data-id="{{ $item->id }}" class="w-9 h-9 flex justify-center items-center border border-footer border-opacity-70 rounded-lg hover:scale-95 transition-all ease-in-out duration-200 hover:border-opacity-100">
                                ...
                                <a href="javascript:void(0)" id="btn-edit-classroom-teacher" data-id="{{ $item->id }}" class="cursor-pointer w-9 h-9 flex justify-center items-center border border-footer border-opacity-70 rounded-lg hover:scale-95 transition-all ease-in-out duration-200 hover:border-opacity-100">
                            ...
                            <button id="btn-delete-classroom-teacher" data-id="{{ $item->id }}" class="w-9 h-9 flex justify-center items-center border border-footer border-opacity-70 rounded-lg hover:scale-95 transition-all ease-in-out duration-200 hover:border-opacity-100 group/hover">
                        ...
                        `;
                        //append to table
                        $('#table-classroom-teacher').prepend(post);
                        ...
                        //close modal
                        $('#modal-classroom-teacher').modal('hide');
                    }
                },
        ...
        //button create post event
        $('body').on('click', '#btn-delete-classroom-teacher', function () {
