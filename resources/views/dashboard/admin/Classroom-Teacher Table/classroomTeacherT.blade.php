...
<div class="pl-12 w-full font-Mplus1cus mt-16">
 ...
 <div class="flex items-center gap-1 mb-2">
                <p class="text-header font-semibold text-xl m-0">List Data</p>
                <button class="w-5 h-5 mt-2 rounded-md flex items-center justify-center group/hover m-0">
                ...
                <a  href="javascript:void(0)" for="tw-modal" id="btn-create-classroom-teacher" data-id="add" class="cmodal cursor-pointer text-subheader font-bold text-[13px] hover:scale-95 transition duration-200">+ add</a>
                <a class="btn btn-success mb-2" style="display: none" id="btn-reset-search">Reset</a>
            </div>

            <table class="w-full" id="table-classroom-teacher">
                <thead>
                    <tr class="font-medium text-xs text-footer text-opacity-60 text-left m-0">
                        ...
                        {{-- <td class=" pt-6 pb-3 pl-0 ">Date</td> --}}
                        <td class=" pt-6 pb-3 pl-0 m-0">Action</td>
                    </tr>
                </thead>
                <tbody id="table-classroom-teacher-body">
                    @foreach ($users as $item)
                    <tr class="font-medium text-[13px] text-header text-left m-0"  id="index_{{ $item->id }}">
                        <td>{{ $item->name }}</td>
                        <td>{{ $item->email }}</td>
                        <td>  
                        ...
                        <td class="p-3 py-[10px] px-0 flex items-center gap-2 w-fit">
                            ...
                            {{-- <a href="{{ route('profile.show') }}" data-id="{{ $item->id }}" class="w-9 h-9 flex justify-center items-center border border-footer border-opacity-70 rounded-lg hover:scale-95 transition-all ease-in-out duration-200 hover:border-opacity-100 group/hover">
