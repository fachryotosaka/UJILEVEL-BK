...
<div class="pl-12 w-full font-Mplus1cus mt-2">
    ...
    <div class="flex flex-col text-xs leading-none mb-12">
        <div class="flex items-center gap-2 font-medium">
            ...
            <p class="text-subheader">Classroom Teacher Table</p>
        </div>
    </div>

    <div class="flex items-center gap-1 mb-2">
        <p class="text-header font-semibold text-xl">Classroom Teacher Data</p>
            ...
            <table class="w-full" id="table-classroom-teacher">
                <thead>
                    <tr class="font-medium text-xs text-footer text-opacity-60 text-left">
                        ...
                        <td class=" p-4 pt-6 pb-5 pl-0">Email</td>
                        <td class=" p-4 pt-6 pb-5 pl-0">Role</td>
                ...
                <tbody id="table-classroom-teacher-body">
                    ...
                    <tr class="font-medium text-[13px] text-header text-left"  id="index_{{ $item->id }}">
                        <td class="p-4 py-[10px] pl-0">{{ $item->name }}</td>
                        <td class="p-4 py-[10px] pl-0">{{ $item->email }}</td>
                        <td class="p-4 py-[10px] pl-0">  
                        ...
                        <td class="p-4 py-[10px] pl-0">{{ $item->classroom->name ?? 'No Class' }}</td>
                        <td class="p-3 py-[10px] px-0 flex items-center gap-2 w-fit">

                            <button id="btn-delete-classroom-teacher" data-id="{{ $item->id }}" class="w-9 h-9 flex justify-center items-center rounded-lg hover:scale-95 transition-all ease-in-out duration-200 hover:border-opacity-100">
                            ...
                            <a href="javascript:void(0)" id="btn-edit-classroom-teacher" data-id="{{ $item->id }}" class="cursor-pointer w-9 h-9 flex justify-center items-center rounded-lg hover:scale-95 transition-all ease-in-out duration-200 hover:border-opacity-100">
