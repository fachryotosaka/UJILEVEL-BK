<!-- Modal -->
<div id="modal-student" tabindex="-1" aria-hidden="true" class="modal z-10 box-border fixed inset-0 p-20 px-32 py-24 pb-10 flex items-center justify-center overflow-hidden overscroll-contain bg-header/30 transition duration-200 pointer-events-auto visible opacity-100 [&>*]:translate-y-0 [&>*]:scale-100">
    ...
    <div class="max-h-full min-w-[50%] w-fit h-fit max-w-full ml-[20%] p-11 px-14 bg-white transition relative rounded-3xl font-Mplus1cus overflow-y-auto hide-scroll">
        ...
        <p class="font-bold text-[28px] text-header">Input Data Student</p>
