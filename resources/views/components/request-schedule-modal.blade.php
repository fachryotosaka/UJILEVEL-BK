...
<div id="modal-request-schedule" tabindex="-1" aria-hidden="true" class="modal z-10 box-border fixed inset-0 p-20 px-32 py-24 pb-10 flex items-center justify-center overflow-hidden overscroll-contain bg-header/30 transition duration-200 pointer-events-auto visible opacity-100 [&>*]:translate-y-0 [&>*]:scale-100">
        ...
        <form class="mt-10 w-full flex flex-col gap-8 overflow-y-auto hide-scroll">        
            ...
            <div id="base-request-form" class="counselingForm w-full flex flex-col gap-8 overflow-y-auto hide-scroll" style="display: none">
                <div class="flex items-center justify-between gap-10">
                    ...
                    <input  id="title" type="text" class="w-[480px] py-3 focus:outline-none focus:border-opacity-90 hover:border-opacity-90 transition duration-200 px-4 border border-footer border-opacity-25 rounded-md font-medium text-xs text-footer">
                    <div class="alert alert-danger mt-2 d-none" role="alert" id="alert-title"></div>
                </div>
    
                <div class="flex items-center justify-between gap-10">
                    <label class="font-semibold text-footer opacity-50 text-[13px] mr-16" for="description">Description</label>
                    <textarea  id="description" type="text" class="w-[480px] py-3 focus:outline-none focus:border-opacity-90 hover:border-opacity-90 transition duration-200 px-4 border border-footer border-opacity-25 rounded-md font-medium text-xs text-footer"></textarea>
                    <div class="alert alert-danger mt-2 d-none" role="alert" id="alert-description"></div>
                </div>
            ...
            <div class="flex items-center justify-end gap-2 mt-8">
                ...
                <button id="confirm" class="rounded-lg bg-gradient-to-br deep-shadow from-blue-main-100 to-blue-main-200 to-[150%] hover:scale-95 transition duration-200 tracking-wide font-semibold text-[11px] text-white px-6 py-3">
                    Save Changes
                </button>
