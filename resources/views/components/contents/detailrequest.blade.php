...
<p class="font-bold text-[28px] text-header text-2xl">Anxiety</p>

<p class="font-Mulish text-sm mt-5 text-sidebar-items">Add a field in the portal to let the user connect their Slack account.</p>
...
<ul class="w-full items-center flex flex-col mt-8 gap-6 font-Mplus1cus">
    ...
    <li class="flex items-center gap-7 w-full">
        ...
        <div class="flex flex-col gap-1 w-[calc(100%/3)]">
            ...
            <p class="font-bold text-[13px] text-header leading-normal">Kazuki Vatel</p>
        </div>

        <div class="flex flex-col gap-1 w-[calc(100%/3)]">
            <p class="font-bold text-[10px] text-sidebar-items font-Mulish opacity-60">Gender</p>

            <p class="font-bold text-[13px] text-header leading-normal">Male</p>
        </div>

        <div class="flex flex-col gap-1 w-[calc(100%/3)]">
            <p class="font-bold text-[10px] text-sidebar-items font-Mulish opacity-60">Time</p>

            <p class="font-bold text-[13px] text-header leading-normal">12:00 AM</p>
        </div>
    ...
    <li class="flex items-center gap-7 w-full">
        ...
        <div class="flex flex-col gap-1 w-[calc(100%/3)]">
            ...
            <p class="font-bold text-[13px] text-header leading-normal">XI PPLG 2</p>
        </div>

        <div class="flex flex-col gap-1 w-[calc(100%/3)]">
            <p class="font-bold text-[10px] text-sidebar-items font-Mulish opacity-60 uppercase">place</p>

            <p class="font-bold text-[13px] text-header leading-normal">LAB</p>
        </div>

        <div class="flex flex-col gap-1 w-[calc(100%/3)]">
            <p class="font-bold text-[10px] text-sidebar-items font-Mulish opacity-60 uppercase">date</p>

            <p class="font-bold text-[13px] text-header leading-normal">27 October 1995</p>
        </div>
    ...
    <div class="flex flex-col gap-1 self-start">
        ...
        <span class="py-2 px-3 bg-[#FFF9F0] font-bold text-[10px] rounded-sm text-center text-[#FFB033] leading-normal">Pending</span>
    </div>
...
<div class="flex items-center gap-4 mt-10 font-Mplus1cus">
    ...
    <button class="px-5 py-3 rounded-md text-[#EAEBEF] font-bold text-xs bg-[#FF4377] hover:scale-95 transition duration-200">Cancel</button>
