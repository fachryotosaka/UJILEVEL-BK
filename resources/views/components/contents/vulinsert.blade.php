...
<p class="font-bold text-[28px] text-header text-2xl">Insert Vulnerability</p>

<form class="flex flex-col items-center mt-6 w-full gap-10">

    <div class="flex items-center w-full">
        <ul class="flex flex-col w-[calc(100%/3)] gap-2">
            <li class="flex items-center gap-2 font-Jost text-[#616161] text-sm">
                <input type="checkbox" class="peer/vul1 vul" name="" id="vul1">
                <label class="peer-checked/vul1:text-blue-main" for="vul1">Anak Bermasalah</label>
            </li>
            <li class="flex items-center gap-2 font-Jost text-[#616161] text-sm">
                <input type="checkbox" class="peer/vul2 vul" name="" id="vul2">
                <label class="peer-checked/vul2:text-blue-main" for="vul2">Sering Terlambat</label>
            </li>
        </ul>
        <ul class="flex flex-col w-[calc(100%/3)] gap-2">
            <li class="flex items-center gap-2 font-Jost text-[#616161] text-sm">
                <input type="checkbox" class="peer/vul3 vul" name="" id="vul3">
                <label class="peer-checked/vul3:text-blue-main" for="vul3">Introvert</label>
            </li>
            <li class="flex items-center gap-2 font-Jost text-[#616161] text-sm">
                <input type="checkbox" class="peer/vul4 vul" name="" id="vul4">
                <label class="peer-checked/vul4:text-blue-main" for="vul4">Banyak Bicara</label>
            </li>
        </ul>
        <ul class="flex flex-col w-[calc(100%/3)] gap-2">
            <li class="flex items-center gap-2 font-Jost text-[#616161] text-sm">
                <input type="checkbox" class="peer/vul5 vul" name="" id="vul5">
                <label class="peer-checked/vul5:text-blue-main" for="vul5">Anak Berbakat</label>
            </li>
            <li class="flex items-center gap-2 font-Jost text-[#616161] text-sm">
                <input type="checkbox" class="peer/vul6 vul" name="" id="vul6">
                <label class="peer-checked/vul6:text-blue-main" for="vul6">Anak Iblis</label>
            </li>
        </ul>
    </div>
    ...
    <div class="flex items-center w-full">
        <ul class="flex flex-col w-[calc(100%/3)] gap-2">
            <li class="flex items-center gap-2 font-Jost text-[#616161] text-sm">
                <input type="checkbox" class="peer/vul7 vul" name="" id="vul7">
                <label class="peer-checked/vul7:text-blue-main" for="vul7">Anak Berprestasi</label>
            </li>
            <li class="flex items-center gap-2 font-Jost text-[#616161] text-sm">
                <input type="checkbox" class="peer/vul8 vul" name="" id="vul8">
                <label class="peer-checked/vul8:text-blue-main" for="vul8">Anak Yatim</label>
            </li>
        </ul>
        <ul class="flex flex-col w-[calc(100%/3)] gap-2">
            <li class="flex items-center gap-2 font-Jost text-[#616161] text-sm">
                <input type="checkbox" class="peer/vul9 vul" name="" id="vul9">
                <label class="peer-checked/vul9:text-blue-main" for="vul9">Tidak Sopan</label>
            </li>
            <li class="flex items-center gap-2 font-Jost text-[#616161] text-sm">
                <input type="checkbox" class="peer/vul10 vul" name="" id="vul10">
                <label class="peer-checked/vul10:text-blue-main" for="vul10">Extrovert</label>
            </li>
        </ul>
        <ul class="flex flex-col w-[calc(100%/3)] gap-2">
            <li class="flex items-center gap-2 font-Jost text-[#616161] text-sm">
                <input type="checkbox" class="peer/vul11" name="" id="vul11">
                <label class="peer-checked/vul11:text-blue-main" for="vul11">Anak Papi</label>
            </li>
            <li class="flex items-center gap-2 font-Jost text-[#616161] text-sm">
                <input type="checkbox" class="peer/vul12" name="" id="vul12">
                <label class="peer-checked/vul12:text-blue-main" for="vul12">Anak All Role</label>
            </li>
        </ul>
    </div>
...
<div class="flex items-center justify-end gap-2 mt-1">
    ...
    <button class="resetVul rounded-lg mr-auto bg-[#eaeaea] flex items-center gap-1 font-semibold text-subheader/80 text-[11px] px-4 py-3 hover:scale-95 transition duration-200">
    ...
    <label for="tw-modal" class="rounded-lg w-10 cursor-pointer py-3 font-semibold text-subheader text-[11px] hover:scale-95 transition duration-200">
        Cancel
    </label>

    <button class="rounded-lg bg-blue-main shadow-xl transition duration-200 tracking-wide font-semibold text-[11px] text-white px-6 py-3 hover:scale-95 cursor-pointer">
        Save
    </button>
