<div class="w-full flex items-center justify-between border-b border-[#EEF2F6] py-7 px-5">

    <a href="/dashboard">
        <p class="font-bold text-[1.125rem] flex items-center gap-[0.375rem]"><span class="text-white w-8 h-8 flex items-center justify-center bg-blue-main rounded-md">R</span> odegree</p>
    </a>
...
<div class="flex flex-col px-5 pt-9 h-full">

    <ul class="flex flex-col font-Mulish font-medium gap-7 pb-8 border-b border-{#EEF2F6}">

        <a href="/dashboard" class="group/hover">
            <li class="flex items-center gap-3 text-[13px] tracking-wide transition duration-200 {{Request::path() == 'dashboard' ? 'text-blue-main font-semibold ' : 'group-hover/hover:text-blue-main text-sidebar-items'}}">
                <svg class="transition duration-200 {{Request::path() == 'dashboard' ? 'stroke-blue-main' : 'group-hover/hover:stroke-blue-main stroke-sidebar-items'}}" width="19.5" height="19.5" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="/request" class="group/hover">
            <li class="flex items-center gap-3 text-[13px] tracking-wide transition duration-200 {{Request::path() == 'siswa' ? 'text-blue-main font-semibold ' : 'group-hover/hover:text-blue-main text-sidebar-items'}}">
                <svg class="transition duration-200 {{Request::path() == 'siswa' ? 'stroke-blue-main' : 'group-hover/hover:stroke-blue-main stroke-sidebar-items'}}" width="16" height="16" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="/vulnerability" class="group/hover">
        ...
        <a href="profile" class="group/hover">
    ...
    <a href="/" class="group/hover text-sidebar-items flex items-center gap-3 text-[13px] tracking-wide font-Mulish font-medium mt-auto transition duration-200 hover:text-blue-main">
