...
@section('dcontent')
    ...
    <div class="w-full h-full flex flex-col overflow-y-auto hide-scroll py-10 px-12 pt-2">
        ...
        <div class="flex items-center order gap-2 font-medium text-xs mb-10">
            <p>Dashboard</p>
            <span>
                <svg class="ml-auto"g width="7" height="11" viewBox="0 0 7 11" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="w-full h-full flex gap-24 font-Mplus1cus">
            ...
            <div class="flex flex-col w-[calc(100%/4)] h-fit">
    
                <div class="flex items-center w-full gap-3 px-0.5">
                    <p class="font-Mulish font-extrabold text-[13px] text-[#1E293B] tracking-wide uppercase">pending</p>
    
                    <span class="rounded-full w-6 h-5 border flex justify-center items-center border-[#E2E8F0] font-Roboto text-sidebar-items font-bold text-xs">2</span>
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <details class="w-full h-fit border bg-white border-[#E2E8F0] cursor-pointer rounded-md p-3 px-4 relative flex flex-col before:absolute before:-z-10 before:h-full before:-right-1 before:-bottom-1 before:rounded-md before:border before:w-full">
                        ...
                        <summary id="detail" class="flex items-center gap-4">
                            ...
                            <div class="w-8 h-8 bg-cover bg-center rounded" style="background-image: url({{asset('img/jun.png')}})"></div>

                            <p class="font-bold text-xs text-header">Kazuki Vatel</p>

                            <svg class="ml-auto rotate" width="11" height="6" viewBox="0 0 11 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <ul class="content flex flex-col gap-4 pt-6 cursor-default">
                            ...
                            <li class="flex items-center w-full">
                                <p class="text-[11px] text-subheader/50 font-medium">Name</p>

                                <p class="text-header/80 text-xs font-semibold max-w-[40%] overflow-ellipsis ml-auto text-limit">Kazuki Vatel</p>
                            </li>

                            <li class="flex items-center">
                                <p class="text-[11px] text-subheader/50 font-medium">Class</p>

                                <p class="text-header/80 text-xs font-semibold max-w-[40%] overflow-ellipsis ml-auto text-limit">XI PPLG 2</p>
                            </li>

                            <li class="flex items-center">
                                <p class="text-[11px] text-subheader/50 font-medium">Place</p>

                                <p class="text-header/80 text-xs font-semibold max-w-[40%] overflow-ellipsis ml-auto text-limit">Nazarick</p>
                            </li>

                            <li class="flex items-center">
                                <p class="text-[11px] text-subheader/50 font-medium">Date</p>

                                <p class="text-header/80 text-xs font-semibold max-w-[40%] overflow-ellipsis ml-auto text-limit">20 August</p>
                            </li>

                            <li class="flex items-center">
                                <p class="text-[11px] text-subheader/50 font-medium">Time</p>

                                <p class="text-header/80 text-xs font-semibold max-w-[40%] overflow-ellipsis ml-auto text-limit">12:00 AM</p>
                            </li>

                            <li class="flex items-center">
                                <p class="text-[11px] text-subheader/50 font-medium">Problem</p>

                                <p class="text-header/80 text-xs font-semibold max-w-[40%] overflow-ellipsis ml-auto text-limit">Romance</p>
                            </li>

                            <label for="tw-modal" data-id="detailrequest" class="cmodal cursor-pointer font-Mulish text-white py-2.5 font-bold text-xs text-center rounded tracking-wide bg-[#306BFF] hover:scale-[.98] transition duration-300">
                                View
                            </label>
            ...
            <div class="flex flex-col w-[calc(100%/4)] h-fit">
                ...
                <div class="flex items-center w-full gap-3 px-0.5">
                    <p class="font-Mulish font-extrabold text-[13px] text-[#1E293B] tracking-wide uppercase">in work</p>
    
                    <span class="rounded-full w-6 h-5 border flex justify-center items-center border-[#E2E8F0] font-Roboto text-sidebar-items font-bold text-xs">3</span>
            ...
            <div class="flex flex-col w-[calc(100%/4)] h-fit">
                ...
                <div class="flex items-center w-full gap-3 px-0.5">
                    <p class="font-Mulish font-extrabold text-[13px] text-[#1E293B] tracking-wide uppercase">qa</p>
    
                    <span class="rounded-full w-6 h-5 border flex justify-center items-center border-[#E2E8F0] font-Roboto text-sidebar-items font-bold text-xs">1</span>
            ...
            <div class="flex flex-col w-[calc(100%/4)] h-fit">
                ...
                <div class="flex items-center w-full gap-3 px-0.5">
                    <p class="font-Mulish font-extrabold text-[13px] text-[#1E293B] tracking-wide uppercase">completed</p>
